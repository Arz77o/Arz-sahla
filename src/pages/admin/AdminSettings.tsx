              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-[9px] text-gray-400 leading-tight">
                    الطلبات التي يتجاوز شحنها هذا المبلغ لن تستفيد من الشحن
                    المجاني للدفع الإلكتروني.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-[9px] text-gray-400 leading-tight">
                    القيمة التي تظهر افتراضياً عند فتح آلة حاسبة الأسعار.
                  </p>
                </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              <div className="overflow-x-auto max-h-[600px]">
                {feesError && (
                  <div className="p-4 text-red-600 bg-red-50 text-center font-bold">
                    {feesError}
                  </div>
                )}
                {isFeesLoading ? (
                  ...
                  <table className="w-full text-right border-collapse">
                    ...
                    <tbody className="divide-y divide-gray-50">
                      {shippingFees
                        .filter(
                          (fee) =>
                            fee.wilaya_name.includes(searchQuery) ||
                            fee.wilaya_code.toString().includes(searchQuery),
                        )
                        .map((fee) => (
                          <tr
                            key={fee.id}
                          ...
                          >
                            <td className="px-6 py-4">
                              <div className="flex items-center gap-3">
                                <span className="text-[10px] font-black text-blue-600 bg-blue-50 px-2 py-0.5 rounded-md min-w-8 text-center">
                                  {fee.wilaya_code}
                                </span>
