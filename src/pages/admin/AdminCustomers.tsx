        ...
        actions={
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="w-full pr-10 pl-4 py-2.5 border border-surface-high bg-white focus:border-primary outline-none"
            />
          </div>
        }
      />
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        <div
                          className={`shrink-0 h-11 w-11 rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-sm ${
                            customer.role === "admin"
                              ? "bg-purple-600"
                              : "bg-blue-600"
                          }`}
