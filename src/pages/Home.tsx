    ...
    <>
      ...
      <section className="py-24 bg-surface-low">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-px bg-surface-high">
            {categories.map((cat) => (
              <Link 
                key={cat.id} 
                to={`/products?category=${cat.slug}`}
                className="group flex flex-col items-center justify-center p-10 bg-white hover:bg-surface-high transition-all duration-300"
              >
